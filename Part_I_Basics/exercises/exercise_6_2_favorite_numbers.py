...
print(favorite_numbers['mrrNonsense'])
print(favorite_numbers['shaoda'])
print(favorite_numbers['xiaoming'])
print(favorite_numbers['icehanba'])
print(favorite_numbers['jyangjun'])
